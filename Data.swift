 ...
 */
    ...
    public static func addRecipe(){
        let reci: Reci.Recipe = Reci.Recipe.init(method: "Chuck shit in bowl", description: "Bit Yuck ay only two herbs", Ingredients: ["superb herb mint fresh","superb herb dill fresh"], Quants: [1,1])
